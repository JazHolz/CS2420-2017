...
public class BinarySearchDeluxeTest {
	...
	private final Integer[] numbers2 = { 10, 9, 8, 8, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 6, 5,
			4, 3, 2, 1 };
	...
	public void testFirstIndexOf_nullArgument() {
		...
		try {
			BinarySearchDeluxe.firstIndexOf(null, "banana", String.CASE_INSENSITIVE_ORDER);
		} catch (NullPointerException e) {
		} catch (Exception e) {
			message += "when array is null ";
		}

		try {
			BinarySearchDeluxe.firstIndexOf(keys, null, String.CASE_INSENSITIVE_ORDER);
		} catch (NullPointerException e) {
		} catch (Exception e) {
			message += "when key is null ";
		}

		try {
			BinarySearchDeluxe.firstIndexOf(keys, "banana", null);
		} catch (NullPointerException e) {
		} catch (Exception e) {
			message += "when comparator is null ";
		}
	...
	public void testLastIndexOf_nullArgument() {
		...
		try {
			BinarySearchDeluxe.lastIndexOf(null, "banana", String.CASE_INSENSITIVE_ORDER);
		} catch (NullPointerException e) {
		} catch (Exception e) {
			message += "when array is null ";
		}
		...
		try {
			BinarySearchDeluxe.lastIndexOf(keys, null, String.CASE_INSENSITIVE_ORDER);
		} catch (NullPointerException e) {
		} catch (Exception e) {
			message += "when key is null ";
		}
		...
		try {
			BinarySearchDeluxe.lastIndexOf(keys, "banana", null);
		} catch (NullPointerException e) {
		} catch (Exception e) {
			message += "when comparator is null ";
		}
