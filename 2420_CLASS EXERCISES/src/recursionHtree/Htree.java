package recursionHtree;

import edu.princeton.cs.algs4.StdDraw;

/******************************************************************************
 * Compilation: javac Htree.java Execution: java Htree n Dependencies:
 * StdDraw.java
 *
...
public class Htree {
	...
	public static void drawH(double x, double y, double size) {
		...
		StdDraw.filledSquare(x0, y1, size / 2); // (x0, y0, x0, y1); // left
												// vertical segment of the H
		StdDraw.filledSquare(x1, y0, size / 2); // (x1, y0, x1, y1); // right
												// vertical segment of the H
		StdDraw.filledSquare(x1, y1, size / 2); // (x0, y, x1, y); // connect
		
		StdDraw.setPenColor(StdDraw.BLACK); // the two vertical segments of
		
		StdDraw.filledSquare(x0, y0, size / 2);
